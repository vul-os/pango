...
import { ApiError, type RegisterFields } from '../lib/api'
...
export default function RegisterPage() {
  ...
  const [form, setForm] = useState<RegisterFields>({ organisation: '', name: '', email: '', password: '' })
  ...
  function set(field: keyof RegisterFields) {
