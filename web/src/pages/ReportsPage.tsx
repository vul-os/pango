...
import { formatMoney, formatMinutes, DEFAULT_CURRENCY } from '../lib/money'
import { formatDate } from '../lib/format'
import Card, { CardHeader } from '../components/ui/Card'
import { Select } from '../components/ui/Field'
import { ErrorState, LoadingState, Skeleton, EmptyState } from '../components/ui/States'
...
interface StatusTilesProps {
  statusQ: UseAsyncResult<StatusReport>
}

function StatusTiles({ statusQ }: StatusTilesProps) {
...
interface TimelineChartProps {
  timelineQ: UseAsyncResult<TimelinePoint[]>
}

function TimelineChart({ timelineQ }: TimelineChartProps) {
...
function MagnitudeBar({ value, max }: MagnitudeBarProps) {
...
interface BuildingReportProps {
  byBuildingQ: UseAsyncResult<BuildingReportRow[]>
}

function BuildingReport({ byBuildingQ }: BuildingReportProps) {
...
interface UnitReportProps {
  byUnitQ: UseAsyncResult<UnitReportRow[]>
  buildings: Building[]
  buildingId: string
  onBuildingChange: (id: string) => void
}

function UnitReport({ byUnitQ, buildings, buildingId, onBuildingChange }: UnitReportProps) {
