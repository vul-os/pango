...
import { jobsApi, buildingsApi, partiesApi, type Building, type Job, type Party, type Unit } from '../lib/api'
import { useAsync } from '../lib/useAsync'
import { useUnitsIndex } from '../lib/useUnitsIndex'
import { BOARD_COLUMNS, JOB_STATUSES, JOB_PRIORITIES, label } from '../lib/domain'
import { StatusPill, PriorityPill, CategoryTag } from '../components/JobBadges'
import { Select, Input } from '../components/ui/Field'
import Button from '../components/ui/Button'
import Card from '../components/ui/Card'
import { EmptyState, ErrorState, Skeleton } from '../components/ui/States'
import { WrenchIcon, PlusIcon, SearchIcon } from '../components/icons'

type BuildingMap = Map<string, Building>
type PartyMap = Map<string, Party>
type UnitsIndex = Map<string, Unit>
...
interface JobCardProps extends JobListProps {
  job: Job
}

function JobCard({ job, buildingMap, unitsIndex, partyMap }: JobCardProps) {
...
interface JobsListProps extends JobListProps {
  jobs: Job[]
}

function BoardView({ jobs, buildingMap, unitsIndex, partyMap }: JobsListProps) {
  return (
...
function ListView({ jobs, buildingMap, unitsIndex, partyMap }: JobsListProps) {
  return (
